...
const Navbar = () => {
    return (
        <div className="items-center flex justify-center gap-x-10 text-sm mb-10">
            ...
            <NavLink className={(e) => e.isActive ? "text-red-300 " : ""} to="/favourite-recipe">Favourites</NavLink>
        </div >
    )
}
